...
namespace User.Application.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task RegisterAsync(DTOs.AuthDTOs.RegisterDto request)
        {
            // 1. Kiểm tra email 
        ...
        public async Task<DTOs.AuthDTOs.LoginResponse> LoginAsync(DTOs.AuthDTOs.LoginRequest request)
        {
            // 1. Tìm User 
            ...
            // 4. Trả về Response
            return new DTOs.AuthDTOs.LoginResponse
            {
                UserId = user.Id,
                Email = user.Email,
